...
import {Star, Heart, ChevronLeft, Minus, Plus, ShoppingCart, ShoppingBasket} from 'lucide-react-native'
...
const ProductDetails = () => {
    ...
    const handleAddToCart = () => {
        addToCart(storeName, {
            ...
            size: selectedSize,
            sizePrices,
            type, rating, reviews, description,
            quantity
        });
    };
        ...
        <View style={styles.infoContainer}>
            <View style={styles.metaContainer}>
                ...
                <View style={styles.quantityContainer}>
                    ...
                    <TextInput style={styles.quantity} value={String(quantity)} onChangeText={(text) => setQuantity(Number(text))} keyboardType="numeric" />
